...
class UserRequest extends Model
{
    ...
    {
        return $this->select("
        permintaan.*, karyawan.nama, C.status as status, D.status as analisis, E.kategori, F.prioritas, penilaian_permintaan.penilaian, penilaian_permintaan.komentar, penilaian_permintaan.progress, G.lampiran, departemen.nama_departemen, it_support.nama as nama_it_support")
            ...
            ->join("sub_permintaan C", 'C.id=permintaan.id_status')
            ->join("sub_permintaan D", 'D.id=permintaan.id_analisis')
            ->join("sub_permintaan E", 'E.id=permintaan.id_kategori')
            ->join("sub_permintaan F", 'F.id=permintaan.id_prioritas')
            ->join("penilaian_permintaan", 'penilaian_permintaan.id_permintaan=permintaan.id')
            ->join("sub_permintaan G", 'G.id=permintaan.id_lampiran')
            ->findAll();
    }
    ...
    {
        return $this->select("
        permintaan.*, karyawan.nama, it_support.nama as nama_it_support, C.status as status, D.status as analisis, E.kategori, F.prioritas, penilaian_permintaan.penilaian, penilaian_permintaan.komentar, penilaian_permintaan.progress, G.lampiran, departemen.nama_departemen")
            ->join("karyawan", 'karyawan.id=permintaan.id_karyawan')
            ->join("it_support", 'it_support.id=permintaan.id_it_support')
            ->join("sub_permintaan C", 'C.id=permintaan.id_status')
            ->join("sub_permintaan D", 'D.id=permintaan.id_analisis')
    ...
    {
        return $this->select("
        permintaan.*, karyawan.nama ,it_support.nama as nama_it_support, C.status as status, D.status as analisis, E.kategori, F.prioritas, penilaian_permintaan.penilaian, penilaian_permintaan.komentar, penilaian_permintaan.progress, G.lampiran, jabatan.nama_jabatan, departemen.nama_departemen")
            ->join("karyawan", 'karyawan.id=permintaan.id_karyawan')
            ->join("it_support", 'it_support.id=permintaan.id_it_support')
            ->join("sub_permintaan C", 'C.id=permintaan.id_status')
            ->join("sub_permintaan D", 'D.id=permintaan.id_analisis')
    ...
    {
        return $this->select("
        permintaan.*, karyawan.nama ,it_support.nama as nama_it_support, C.status as status, D.status as analisis, E.kategori, F.prioritas, penilaian_permintaan.id as id_penilaian, penilaian_permintaan.penilaian, penilaian_permintaan.komentar, penilaian_permintaan.progress, G.lampiran, jabatan.nama_jabatan, departemen.nama_departemen")
            ->join("karyawan", 'karyawan.id=permintaan.id_karyawan')
            ->join("it_support", 'it_support.id=permintaan.id_it_support')
            ->join("sub_permintaan C", 'C.id=permintaan.id_status')
            ->join("sub_permintaan D", 'D.id=permintaan.id_analisis')
    ...
    {
        $builder = $this->db->table('sub_permintaan');
        $builder->select('*');
        $query = $builder->get()->getResult();
        return $query;
    }
    ...
    {
        return $this->select("
        permintaan.*, karyawan.nama, it_support.nama as nama_it_support, C.status as status, D.status as analisis, E.kategori, F.prioritas, penilaian_permintaan.progress, penilaian_permintaan.penilaian, penilaian_permintaan.komentar, G.lampiran, jabatan.nama_jabatan, departemen.nama_departemen")
            ->join("karyawan", 'karyawan.id=permintaan.id_karyawan')
            ->join("it_support", 'it_support.id=permintaan.id_it_support')
            ->join("sub_permintaan C", 'C.id=permintaan.id_status')
            ->join("sub_permintaan D", 'D.id=permintaan.id_analisis')
