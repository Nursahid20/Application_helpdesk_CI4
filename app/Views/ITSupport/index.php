...
<div class="app-content pt-3 p-md-3 p-lg-4">
    <h2 class="app-page-title">Data IT Support</h2>
    <div class="app-card shadow-sm h-100">
        <div class="app-card-body p-3 p-lg-4">
            ...
            <a href="<?= base_url('/admin/addITSupport') ?>" class="btn btn-outline-success">
                <i class="fas fa-user-tie"></i>
                Tambah Data IT Support
            </a>
            <br><br>
                ...
                <tbody>
                    ...
                    for ($i = 0; $i < $number; $i++) { ?>
                        <tr>
                            ...
                            <td class="cell"><?= $data[$i]['jabatan']; ?></td>
                            <td class="cell"><?= $data[$i]['departemen']; ?></td>
                            <td class="cell">
                                <a href="javascript:;" class='btn btn-outline-warning details' data-id="<?php echo $data[$i]['id']; ?>" data-nik="<?php echo $data[$i]['nik']; ?>" data-email="<?php echo $data[$i]['email']; ?>" data-nama="<?php echo $data[$i]['nama']; ?>" data-tanggal_lahir="<?php echo $data[$i]['tanggal_lahir']; ?>" data-tempat_lahir="<?php echo $data[$i]['tempat_lahir']; ?>" data-no_telepon="<?php echo $data[$i]['no_telepon']; ?>" data-jk="<?php echo $data[$i]['jk']; ?>" data-perusahaan="<?php echo $data[$i]['perusahaan']; ?>" data-departemen="<?php echo $data[$i]['departemen']; ?>" data-jabatan="<?php echo $data[$i]['jabatan']; ?>" data-alamat="<?php echo $data[$i]['alamat']; ?>" data-foto_profile="<?php echo $data[$i]['foto_profile']; ?>" data-bs-toggle="modal" title="Details" data-bs-target="#ModalInfo" data-id="<?= $data[$i]['id']; ?>"><i class="fas fa-info"></i></a>
                                <a href="<?= base_url('/admin/editITSupport/' . $data[$i]['id']) ?>" class="btn btn-outline-info" title="Edit"><i class="fa fa-edit"></i></a>
                                <form action="/admin/ITSupport/<?= $data[$i]['id']; ?>" method="post" class="d-inline">
                                    <?= csrf_field(); ?>
                        ...
                        <div class="p-3 py-4">
                            ...
                            <div class="row mt-2">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" readonly name="jabatan" id="jabatan" class="form-control" placeholder="" value="">
                                </div>
                                <div class="col-md-6">
                                    <label class="labels">Departemen</label>
                                    <input type="text" readonly name="departemen" id="departemen" class="form-control" value="" placeholder="">
                                </div>
                            </div>
                            <div class="row mt-2">
...
<script>
    $(document).ready(function() {
        ...
        $('#ModalInfo').on('show.bs.modal', function(event) {
            ...
            modal.find('#departemen').attr("value", div.data('departemen'));
