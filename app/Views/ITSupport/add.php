...
<div class="app-content pt-3 p-md-3 p-lg-4">
    <h2 class="app-page-title">Tambah IT Support</h2>
    ...
    <div class="app-card shadow-sm h-100">
        <div class="app-card-body p-3 p-lg-4">
            <form action="/admin/saveITSupport" method="post" enctype="multipart/form-data">
                <?= csrf_field(); ?>
                <div class="row pb-2">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 pb-2">
                        ...
                        <input type="text" class="form-control" id="departemen" readonly name="departemen" value="IT">
                    </div>
                    <div class="col-sm-6 pb-2">
                        <label for="jabatan" class="form-label">Jabatan</label>
                        <input type="text" class="form-control" id="jabatan" readonly name="jabatan" value="IT SUPPORT">
                    </div>
