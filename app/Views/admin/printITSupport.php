...
<head>
    <title>Laporan Data IT Support</title>
    <!-- App CSS -->
...
<body style="padding-top: 15px;">
    <center>
        ...
        <hr>
        <h4 class="text3" style="font-weight: bold;">Laporan Data IT Support</h4>
            ...
            <tbody>
                ...
                for ($i = 0; $i < $number; $i++) { ?>
                    <tr>
                        ...
                        <td><?= $dataUser[$i]['jabatan']; ?></td>
                        <td><?= $dataUser[$i]['departemen']; ?></td>
