...
<div class="app-content pt-3 p-md-3 p-lg-4">
    ...
    <a href="<?= base_url('/admin/requestFeedbackPDF'); ?>" target="_blank" class="btn btn-outline-info"><i class="fas fa-print"></i></a>&nbsp Cetak Saran/Kritik Permintaan Karyawan
    <br><br><br>
    <h3 class="app-page-title">Filter laporan Saran/Kritik Permintaan Karyawan</h3>

    <form action="/admin/printRequestFeedbackPDF/" method="POST" target="_blank">
        <div class="row">
