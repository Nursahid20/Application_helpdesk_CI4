...
<head>
    <title>Laporan Data Kritik/Saran Permintaan</title>
    <!-- App CSS -->
...
<body style="padding-top: 15px;">
    <center>
        ...
        <hr>
        <h4 class="text3" style="font-weight: bold;">Laporan Data Kritik/Saran Permintaan Karyawan</h4>
            ...
            <tbody>
                ...
                for ($i = 0; $i < $number; $i++) { ?>
                    <tr>
                        ...
                        <td><?= $dataUser[$i]['kode_permintaan']; ?></td>
                        <td>
                            <?php
                            $d = explode('-',  $dataUser[$i]['updated_at']);
                            $hari = $d[2];
                            $bulan = $d[1];
                            $tahun = $d[0];
                        ...
                        <td><?= $dataUser[$i]['penilaian']; ?></td>
                        <td><?= $dataUser[$i]['komentar']; ?></td>
                    </tr>
                <?php } ?>
            </tbody>
        </table>
