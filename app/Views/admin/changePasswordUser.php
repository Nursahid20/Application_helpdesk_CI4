...
<div class="app-content pt-3 p-md-3 p-lg-4">
    <h2 class="app-page-title">Ganti Password User</h2>
    ...
    <div class="app-card shadow-sm h-100">
        <div class="app-card-body p-3 p-lg-4">
            <form action="/admin/savePasswordUser/<?= $dataUser['id']; ?>" method="post" enctype="multipart/form-data">
                <?= csrf_field(); ?>
                <div class="row">
                    ...
                    <div class="col-sm-12 pb-2">
                        ...
                        <input type="level_user" class="form-control <?= ($validation->hasError('level_user')) ? 'is-invalid' : ''; ?>" id="level_user" name="level_user" readonly value="<?= $dataUser['level_user']; ?>">
                        <div class="invalid-feedback">
