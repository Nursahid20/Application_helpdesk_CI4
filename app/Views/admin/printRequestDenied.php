...
<body style="padding-top: 15px;">
    <center>
        ...
        <hr>
        <h4 class="text3" style="font-weight: bold;">Laporan Data Permintaan Karyawan Ditolak</h4>
            ...
            <tbody>
                ...
                for ($i = 0; $i < $number; $i++) { ?>
                    <tr>
                        ...
                        <td><?= $dataUser[$i]['prioritas']; ?></td>
                        <td><?= $dataUser[$i]['kategori']; ?></td>
                        <td><?= $dataUser[$i]['nama']; ?></td>
                        <td><?= $dataUser[$i]['nama_it_support']; ?></td>
                        <td><?= $dataUser[$i]['nama_departemen']; ?></td>
                        <td><?= $dataUser[$i]['analisis']; ?></td>
